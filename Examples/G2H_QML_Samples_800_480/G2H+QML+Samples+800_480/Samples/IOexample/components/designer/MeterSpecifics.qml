...
Column {
    ...
    Section {
        ...
        SectionLayout {
            ...
            Label {
                text: "Start of Green Marker"
            }

            SecondColumnLayout {
                SpinBox {
                    backendValue: backendValues.startOfGreenMarker
                    minimumValue: 0
                    maximumValue: 2000
                    decimals: 0
                }
            ...
            Label {
                text: "End of Green Marker"
            }

            SecondColumnLayout {
                SpinBox {
                    backendValue: backendValues.endOfGreenMarker
                    minimumValue: 0
                    maximumValue: 2000
                    decimals: 0
                }
            ...
            Label {
                text: "End of Orange Marker"
            }

            SecondColumnLayout {
                SpinBox {
                    backendValue: backendValues.endOfOrangeMarker
                    minimumValue: 0
                    maximumValue: 2000
                    decimals: 0
                }
